...
MyGame = ig.Game.extend({
	...
	update: function() {
		...
		{
			ig.game.playSound = !ig.game.playSound;
		}
		...
		/* 显示数据面板 */
		if(ig.input.pressed('static')) {
			ig.game.showStats = !ig.game.showStats;
		}
	...
	draw: function() {
		...
		if(this.showStats){
			...
			ig.system.context.fillText( '过关', x - 40, y - 50 );
			ig.system.context.fillText( '硬币: '+this.stats.coins, x - 40, y - 20 );
			ig.system.context.fillText( '击杀: '+this.stats.kills, x - 40, y + 10);
			ig.system.context.fillText( '死亡: '+this.stats.deaths, x - 40, y + 40 );
			ig.system.context.fillText( '点击空格继续', x - 60, y + 70 );
		}
	},
	gameOver: function() {
...
StartScreen = ig.Game.extend({
	...
	draw: function(){
		...
		ig.system.context.fillText( '点击空格继续', x, y + 30 );
	},
});
...
GameOverScreen = ig.Game.extend({
	...
	draw: function() {
		...
		ig.system.context.fillText( '击杀: ' + this.stats.kills, x - 40, y + 10 );
		ig.system.context.fillText( '死亡: ' + this.stats.deaths, x - 40, y + 40 );
		ig.system.context.fillText( '得分: ' + score, x - 40, y + 70 );
		ig.system.context.fillText( '点击空格继续', x - 60, y + 100 );
	}
});
